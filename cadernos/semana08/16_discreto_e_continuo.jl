...
Qual a relação entre os dois conceitos? Indexação pode ser vista como uma regra (fórmula, tabela) que dado índice devolve um valor. É uma função do conjunto de índices (que é discreto) no conjunto de valores armazenado no vetor!
...
function colorgoodbad(should_be, given)
    ...
    @htl(
        """
    <span style="color:green">$(given[1:indexofmistake-1])</span><span style="color: red">$(given[indexofmistake:end])</span>
    """
    )
end
...
manifest_format = "2.0"
project_hash = "8c94bc5ac2a3ab523c03d951ad7be9c0dd74f06e"
