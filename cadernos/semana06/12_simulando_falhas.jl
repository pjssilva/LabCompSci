...
md"""
O objeto `B` representa uma distribuição Bernoulli com probabilidade $p$. Ele pode ser usada sempre que precisarmos de uma distribuição desse tipo. Você agora pode tentar criar o seu próprio mini pacote com sua distribuição simples. Assim não vai precisar fazer copia-e-cola quando precisar reutilizá-la. 
