...
Vamos aumentar a em passos de 0.25 indo de -4 até 4 e depois decrescer de 4 a menos 4. Toda vez que aumentarmos a vamos permitir que passem 10 passos de tempo, para que o novo equilíbrio, associado àquele a, seja alcançado. 
...
Mas o que ocorre para T₀ ≈ $(round(T_un, digits=2)) °C? Para alguma temperatura aí próxima existe um outro equilíbrio que é _instável_. Se o sistema começa exatamente nele ficará nele para sempre. Mas mesmo pequenos desvios levam a busca de um dos outros dois equilíbrios que são _estáveis_. Eles são _atratores_.
"
