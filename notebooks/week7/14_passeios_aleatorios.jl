...
md"""
A trajetória, or caminho amostrado, do passeio aleatório, é a coleção de posições ao longo to tempo obtidas a partir das _somas parciais_ (estamos considerando que $S_0 = 0$):
