...
md"""
Para isso, parece natural simplesmente varrer os dados e pegar os valores máximo e mínimo de $x$. Porém os dados podem conter alguns poucos valores muito grandes, ou muito pequenos, muitas vezes chamados de **outliers**. Se existirem, apensar de menos relevantes, eles vão definir completamente os valores máximos e mínimos. Isso indepenpendetemente do comportamento da **maior parte** dos dados.
