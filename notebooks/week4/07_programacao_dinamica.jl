...
Vamos começar entendero um pouco melhor o que queremos. Começamos por gerar um matriz aletória m × n.
"""
...
md"""
Note que um dos problemas fundamentais do problema é que não é fácil aporveitar isso. No final das contas ao cruzarmos um nó acabamos recalculando todos os possíveis caminhos que passam por ele e isso é feito repetidas vezes.
...
begin
    ...
    function next_path(path, n)
        ...
        # adding 1. This is just like adding one in a number
