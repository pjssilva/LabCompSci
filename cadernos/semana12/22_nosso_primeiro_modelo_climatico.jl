...
md"""
Na matemática, nós partimos da equação diferencial, imaginando que ela é conhecida. Mas no mundo físico essas equações dependem de parâmetros que precisam ser identificados.
...
**Observação:** O sinal $B < 0$ modela que o retorno climático é **negativo** (tem efeito estabilizante). Efeitos de retorno positivo levam $B$ a ficar menos negativo. Isso reduz a eficiência com que a Terra é capaz de se resfriar ao irradiar energia térmica para o espaço. Isso aplificaria o aquecimento.
...
manifest_format = "2.0"
project_hash = "d4a2ef3c76ece52c3b6345971d55230c16655c6a"
...
git-tree-sha1 = "16a2298041095e12d204a549c65be172f13ef070"
